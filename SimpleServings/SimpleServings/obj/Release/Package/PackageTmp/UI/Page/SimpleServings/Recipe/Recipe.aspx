...
<input type="search" class="recipeSearchBox" placeholder="Search Recipe by Name..." id="recipeSearchBox" onkeypress="return recipeSearchBoxKeyPress(event)" />
        ...
        <div  class="contentBox marginTophack">
         ...
         <div style="width:98%; height:100%; border-top: 1px solid #e5e5e5;"> &nbsp;<div style="padding:10px; margin:5px; width:80%; height:100%; border-radius:3px;">
             <input type="text" runat="server" class="recipeSearchBox" placeholder="Search Recipe by Name..." id="txtsearch" />
         </div>
