...
<div class="brPanelCover"></div>
    ...
    <form  id="Form1" defaultbutton="btnLogin" runat="server" method="post" class="form-vertical login-form">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-user"></i>
            <asp:textbox class="m-wrap placeholder-no-fix" placeholder="Username"  ID="txtUserName" runat="server" Text="Username" />
      ...
      <div class="form-actions">       
         <asp:Button  CssClass="btn green pull-right" ID="btnLogin" runat="server" CommandName="Login" Text="Log in" OnClientClick="newSession();" onClick="btnLogin_Click" />             
      </div>
