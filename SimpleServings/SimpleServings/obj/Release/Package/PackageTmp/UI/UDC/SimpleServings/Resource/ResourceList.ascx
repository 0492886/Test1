...
<asp:GridView runat="server" CssClass="DatagridStyle table table-hover"  ID="gvResources" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true" PageSize="50" OnSorting="gvResources_Sorting">
