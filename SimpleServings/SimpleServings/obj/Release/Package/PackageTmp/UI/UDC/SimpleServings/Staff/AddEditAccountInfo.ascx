              ...
              <div class="dataRow w500">
                    ...
                    <div class="dataLabel">Password :</div>                    
                     ...
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator2" CssClass="msglabel" Text="Invalid Password" runat="server" ControlToValidate="txtPassword"
                                    ValidationExpression="^(\w+)$" Display="Dynamic" />
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtPassword" ErrorMessage="* required" />
                     </div>
                     <div class="dataInput">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtConfirmPassword" ErrorMessage="* required" />
                    <br />
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" ErrorMessage="passwords do not match" /></div>
                 </div>
