...
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
 <%@ Register src="../Supplier/ContractGrid.ascx" tagname="ContractGrid" tagprefix="uc2" %><%@ Register src="../Supplier/ListContract.ascx" tagname="ListContract" tagprefix="ucConList" %><%@ Register src="MenuGrid.ascx" tagname="MenuGrid" tagprefix="ucMenuGrid" %>
