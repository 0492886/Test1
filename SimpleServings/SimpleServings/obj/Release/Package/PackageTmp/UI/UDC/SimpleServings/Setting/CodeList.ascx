...
<asp:Panel ID="pnPage"  CssClass="contentBox" runat="server">
   <div class="title2"><span class="h2Size">Code Management</span>
    ...
    <ul class="floatR">
                ...
                <li><asp:HyperLink ID="hlInsertCode" runat="server" Target="_blank" CssClass="add floatR">Add Code</asp:HyperLink></li>
                <li><asp:HyperLink CssClass="add floatR" ID="hlAddRule" runat="server" Target="_blank">Add Rule</asp:HyperLink></li>
                <li><asp:HyperLink CssClass="check floatR" ID="hlViewRules" runat="server" Target="_blank">View Rules</asp:HyperLink></li>              
            </ul>
     </div>
