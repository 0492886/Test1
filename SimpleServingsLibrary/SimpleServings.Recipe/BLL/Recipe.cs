...
namespace SimpleServingsLibrary.Recipe
{
    public class Recipe
    {
        ...
        public static Recipes GetRecipesforTagsSearch(List<int> TagIDs, string RecipeSearchText)
        {
            return PopRecipesForRepeater(RecipeDB.GetRecipesforTagsSearch(TagIDs, RecipeSearchText));
