...
namespace SimpleServingsLibrary.Menu
{
    ...
    public class Menu
    {
        ...
        public static Menus GetMyMenusByUserIDContractIDpeMenuStatus(int staffID, int contractID, int menuStatus, int currentMenus)
        {
            return PopMenus(MenuDB.GetMyMenusByUserIDContractIDpeMenuStatus(staffID, contractID, menuStatus,currentMenus));
        }
